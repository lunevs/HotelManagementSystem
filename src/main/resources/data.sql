...
insert into public.locations (deleted, location_admin_id, description, name)
values  (false, 1, 'описание нашего классного отеля в горах', 'Отель в горах'),
        (false, 1, 'описание нашего отеля в городе, что рядом и т.д.', 'Городские апартаменты'),
        (false, 1, 'первая линия, лучшие пляжи и все такое', 'Морской берег');

insert into public.rooms (capacity, deleted, price, location_id, name)
